...
function installNodeExporter {
	...
	tar xvfz node_exporter-*.*-amd64.tar.gz && cp node_exporter-*.*-amd64/node_exporter . && chown -R blockpi_monitor:blockpi_monitor /opt/node_exporter/
  wget -O /etc/systemd/system/node_exporter.service  https://raw.githubusercontent.com/davaymne/blockpilabs-hypernode-klaytn-monitoring/main/node_exporter.service
...
function installPrometheus {
	...
	cd /opt/prometheus
	echo -e '\n\e[42mDownloading packages...\e[0m\n'
  wget -O prometheus.yml https://raw.githubusercontent.com/davaymne/blockpilabs-hypernode-klaytn-monitoring/main/prometheus/prometheus.yml
	...
	tar xvfz prometheus-*.*-amd64.tar.gz && cp prometheus-*.*-amd64/prometheus . && chown -R blockpi_monitor:blockpi_monitor /opt/prometheus/ /var/lib/prometheus/
  wget -O /etc/systemd/system/prometheus.service https://raw.githubusercontent.com/davaymne/blockpilabs-hypernode-klaytn-monitoring/main/prometheus.service
...
function installGrafana {
  ...
  wget -O /etc/grafana/provisioning/datasources/prometheus.yml https://raw.githubusercontent.com/davaymne/blockpilabs-hypernode-klaytn-monitoring/main/grafana/provisioning/datasources/prometheus.yml
  wget -O /etc/grafana/provisioning/dashboards/dashboards.yml https://raw.githubusercontent.com/davaymne/blockpilabs-hypernode-klaytn-monitoring/main/grafana/provisioning/dashboards/dashboards.yml
	wget -O /etc/grafana/provisioning/dashboards/HyperNode.json https://raw.githubusercontent.com/davaymne/blockpilabs-hypernode-klaytn-monitoring/main/grafana/provisioning/dashboards/HyperNode.json
