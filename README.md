...
```
wget -q -O blockpi-monitoring-installer.sh https://raw.githubusercontent.com/davaymne/blockpilabs-hypernode-klaytn-monitoring/main/blockpi-monitoring-installer.sh && chmod +x blockpi-monitoring-installer.sh && sudo /bin/bash blockpi-monitoring-installer.sh
```
